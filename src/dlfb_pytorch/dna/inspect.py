...
from dlfb_pytorch.dna.utils import compute_input_gradient, filter_sequences_by_label
from dlfb_pytorch.utils.metric_plots import MetricsPlotter
...
def plot_10_gradients(model, dataset, target_label, max_count=10):
  """Plot saliency maps for 10 sequences of a given label."""
  input_grads = [
    compute_input_gradient(model, sequence)
